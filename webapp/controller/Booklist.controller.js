    ...
    return Controller.extend("org.ubb.books.controller.Booklist", {
        ...
        onSavePressed(oEvent){
            ...
            var oBook = {
                ...
                "NrOfBooksAvbl": parseInt(oAvailable)
            };

            this.odataModel = new sap.ui.model.odata.ODataModel("/sap/opu/odata/SAP/Z801_ODATA_IUDO_SRV");
            this.odataModel.create('/Z801_BOOK_ENTITY_IUDOSet', oBook);
            this.dialog.close();
            this.dialog.destroy();
            //reload page
        ...
        onUpdateBook(oEvent){
            ...
            var available = selectedItem.getBindingContext().getProperty("NrOfBooksAvbl");
        ...
        onUpdatePressed(oEvent){
            ...
            this.odataModel = new sap.ui.model.odata.ODataModel("/sap/opu/odata/SAP/Z801_ODATA_IUDO_SRV");
            this.odataModel.update("/Z801_BOOK_ENTITY_IUDOSet('"+oISBN+"')", oBook, null, function(){
